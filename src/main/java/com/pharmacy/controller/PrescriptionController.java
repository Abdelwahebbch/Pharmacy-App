...
public class PrescriptionController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        prescriptionList.addAll(
            new Prescription("John Smith", "Dr. Emily Johnson", "Amoxicillin 500mg - 3 times daily\nIbuprofen 400mg - as needed", 
                            LocalDate.now().minusDays(5), LocalDate.now().plusMonths(1)),
            new Prescription("Sarah Williams", "Dr. Michael Chen", "Lisinopril 10mg - once daily\nAspirin 81mg - once daily", 
                            LocalDate.now().minusDays(10), LocalDate.now().plusMonths(3)),
            new Prescription("Robert Brown", "Dr. Lisa Anderson", "Ventolin Inhaler - as needed\nPrednisone 20mg - daily for 5 days", 
    ...
    private void handleAddPrescription() {
        try {
            ...
            Prescription newPrescription = new Prescription(patientName, doctorName, medications, issueDate, expiryDate);
